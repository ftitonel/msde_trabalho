 ...
 * </p>
 * <ul>
 *   <li>{@link br.uece.ppgcc.esdm.cml.impl.ClauseImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ClauseImpl extends MinimalEObjectImpl.Container implements Clause {
	...
	protected EClass eStaticClass() {
		return CmlPackage.Literals.CLAUSE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CmlPackage.CLAUSE__NAME, oldName, name));
	}
